...
export const STARTUP_NOTICES: readonly StartupNotice[] = [
  ...
  },
  {
    ...
    items: [
      ...
      '改善: 編集履歴が多いワークスペースの起動が大幅に速くなりました。実測(15000 エントリ・履歴 45000 件)で 27.2 秒 → 3.1 秒(約 8.7 倍)。サイドバーの各行で「履歴あり」の印を出すために、1 行ごとに履歴全体を数え直していたのが原因です(エントリ数 × 履歴数に比例して遅くなっていました)。履歴が多いほど効果があります',
