...
export const STARTUP_NOTICES: readonly StartupNotice[] = [
  ...
  },
  {
    ...
    items: [
      ...
      '改善: 差分保存(differential_save)をオンにしているとき、編集のたびの書き込み量が大幅に減りました。実測(5000 エントリ・履歴 15000 件・関連 3074 件)で 1 編集あたり 1,270KB → 194KB(約 6.5 分の 1)。エントリ同士の「関連」が、本文を 1 文字直しただけでも毎回まるごと書き直されていたのが原因です(関連が変わったときだけ書くようにしました)',
