...
## §1 現状 flag inventory(37 件、shell/text/editor + その他)
...
### §1.3 editor.* flag(2 件、pgc-196 + pgc-203 追加)
...
| 37 | `editor.mermaid_render_enabled` | pgc-203 | OFF | ` ```mermaid ` fence を mermaid.js で SVG render(lazy import、3 surface S1/S2/S4 統一、theme aware)| 維持(bundle.js が +3 MB、5 MB 分水嶺超過の判断 user 委ね、`shell.activity_bar_badges_enabled` 等と独立)|
