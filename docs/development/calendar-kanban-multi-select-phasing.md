...
Status: COMPLETED (Phase 1 + 2-A/B/C/E + drag ghost 完了。2-D は CANDIDATE)
Created: 2026-04-11
...
| Phase 2-C1 | Multi-DnD: Kanban | **COMPLETED** | `calendar-kanban-multi-select-multi-dnd.md` |
| Phase 2-C2 | Multi-DnD: Calendar | **COMPLETED** | `calendar-kanban-multi-select-multi-dnd.md` |
| Phase 2-C3 | Multi-DnD: Cross-view (flag 統合 + テスト) | **COMPLETED** | `calendar-kanban-multi-select-multi-dnd.md` S8 |
| Phase 2-D | SELECT_RANGE 表示順対応 | CANDIDATE | — |
| Phase 2-E | Escape キーで CLEAR_MULTI_SELECT | **COMPLETED** | `calendar-kanban-multi-select-escape-clear.md` |
...
| Phase 2-E | Escape で CLEAR_MULTI_SELECT | 11 | `calendar-kanban-multi-select-escape-clear.md` |
| (UX) | Drag ghost N件バッジ (setDragImage) | 9 | `multi-dnd-drag-ghost-ux.md` |
