...
Last updated: 2026-04-24（Phase 2 step 1 docs-first: Normalize PKC links migration tool v1 spec を固定、既存 body の legacy PKC link 正規化の契約と 4 slice 実装順を確定、実装は後続）.
