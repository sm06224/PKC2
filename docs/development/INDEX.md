...
Last updated: 2026-04-24（Phase 2 Slice 1 follow-up: Harbor Philosophy 整合で Candidate D を scanner v1 から撤去、canonical image embed を保護する regression tests を追加、spec に future dialect reservations 節を新設）.
