...
Last updated: 2026-04-24（Link system audit + 正本化計画: 4 surface 棚卸し / gap list G1-G7 / Copy 1 本化 / Internal Markdown Dialect / Migration policy / 次 PR 順序を確定、docs-only Phase 0）.
