...
Last updated: 2026-04-24（Link system manual / docs sync: 3 層用語(External Permalink / Portable PKC Reference / Internal Reference)と Copy/Paste/Open 導線をマニュアルに反映、card/embed 実装前の用語揃え）.
