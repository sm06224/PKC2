...
Last updated: 2026-04-24（Phase 2 Slice 2: Normalize PKC links preview UI dialog を実装、Shell menu Tools セクションから scanner v1 A/B/C を列挙、Apply は Slice 3 に持ち越し、16 integration tests 追加）.
