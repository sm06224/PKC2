...
Last updated: 2026-04-24（Clickable-image renderer audit: docs-only、標準 Markdown clickable-image の将来採用に向けて renderer / resolver / action-binder の責務境界と migration v1/v2 境界を明文化、Next-step PR option A / B の判断材料を集約）.
