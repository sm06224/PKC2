...
Last updated: 2026-04-24（Phase 2 Slice 3: Apply reducer + revision 連携を実装、pure planner `applyLinkMigrations` + `APPLY_LINK_MIGRATION` action、stale candidate skip、bulk_id 共有 revision 記録、dialog の Apply all safe button + 結果 banner、22 tests 追加）.
