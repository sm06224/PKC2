...
Last updated: 2026-04-24（Same-container Portable Reference fallback rendering: body 内に残った `[](pkc://<self>/entry/<lid>)` が `entry:<lid>` と同等の navigate-entry-ref として動作、Link system 整合性仕上げ）.
