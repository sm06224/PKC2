...
Last updated: 2026-04-24（Phase 3 完了: user-visible version を v2.1.0 へ bump、About に release highlights + known limitations を表示、CHANGELOG_v2.1.0.md と versioning-policy.md を追加）.
