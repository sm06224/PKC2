...
Last updated: 2026-04-24（Link terminology / grammar correction: `pkc://` を「permalink」呼称から外し 3 概念(Internal / Portable / External Permalink)に分離、Copy link UI を外部クリック可能な External Permalink emit に変更）.
