...
Last updated: 2026-04-24（Phase 1 step 5 実装 / Phase 1 完了: context menu Internal Reference copy を `📝 Markdown source` group に集約、通常導線は `🔗 Copy link` = External Permalink に 1 本化、audit G6 解消）.
