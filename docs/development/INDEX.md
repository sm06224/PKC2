...
Last updated: 2026-04-24（Phase 1 step 3 実装: Paste conversion log-label support、`fragment=log/<logId>` を `[<title> › <snippet>](entry:<lid>#log/<logId>)` に動的変換、Copy ↔ Paste loop 完成）.
