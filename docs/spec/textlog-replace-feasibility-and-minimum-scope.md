...
Related: docs/spec/find-replace-behavior-contract.md, docs/development/text-replace-current-entry.md, docs/development/textlog-foundation.md, docs/development/textlog-viewer-and-linkability-redesign.md, src/features/textlog/textlog-body.ts, src/adapter/ui/textlog-presenter.ts
Supersedes: —
...
| `docs/development/text-replace-current-entry.md` | TEXT 側の実装 dev doc。pure helper と dialog の層分離パターンを示している |
| `docs/development/textlog-foundation.md` | textlog 全体構造の解説 |
