...
- `docs/development/completed/textlog-foundation.md` — TEXTLOG archetype 導入
...
- `docs/development/completed/text-textlog-editing-ux-consolidation.md` — TEXT/TEXTLOG 変換 UX
...
- `docs/development/completed/todo-view-consistency.md` — TODO 全 view 共通仕様
