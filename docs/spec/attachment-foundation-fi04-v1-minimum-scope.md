...
Status: 実装済み(v2.1.0 以前に landing、v2.1.1 時点で稼働中)。本書は minimum-scope / historical design record として保持。実装の現物は `src/adapter/ui/attachment-presenter.ts` / asset 系 features / adapter platform + 関連 tests。  
