...
- **Tier 3-1**: **A. merge import 実装（Overlay MVP）** ← **完了（2026-04-14）**
- **Tier 3-2**: **D. release automation** + **C の軽量部分**（bundle
  size budget + E2E smoke baseline）← **完了（2026-04-14）**
...
| 2026-04-14 | Tier 3-1 完了印を追記（merge import Overlay MVP 実装） |
| 2026-04-14 | Tier 3-2 完了印を追記（release automation + bundle size budget + Playwright smoke baseline） |
