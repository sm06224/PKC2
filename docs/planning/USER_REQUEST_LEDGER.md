...
**Date**: 2026-04-16（Post-v0.1.0 Editor UX Pack 完了時点 / commit `0edf6ea`）
...
| **ユーザー明示要望 — 部分完了** | 0 |
| **ユーザー明示要望 — 未完（着手中）** | 0 |
| 待機中候補（idea / vision / HANDOVER decline、§3） | **17**（重複込 21、H-3 / H-4 / H-6 / H-7 / H-8 完了、A-4 / B-3 部分完了統合済）※ 2026-04-16 時点。以前は 26 と表示していた行は stale だったため削除済み |
