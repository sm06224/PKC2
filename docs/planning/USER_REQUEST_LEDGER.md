...
**Date**: 2026-04-21（relations / references / provenance / orphan wave + P1–P5 wave + hook subscription Defer + transport record 完了後の追補）
...
| 状態 | 件数 |
|-----|-----|
| **ユーザー明示要望 — 完了** | **68**（2026-04-17 時点 46 + 2026-04-19〜21 wave +22）|
| **ユーザー明示要望 — 部分完了** | **1**（S-56 P5 Extension Capture — v0 docs-only draft 完了、receiver 実装は pending）|
| **ユーザー明示要望 — 未完（着手中）** | 0 |
