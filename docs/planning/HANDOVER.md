...
**最終更新**: Issue #26 完了時点（Detail Presenter / Archetype Dispatch Foundation）
...
前セッションで Issue #1〜#26 が完了しており、feature 層の検索・ソート・relation 観測・tags・tag filter・archetype dispatch 基盤が成立しています。
...
テスト: 451 tests 全通過、typecheck clean、lint clean
...
tests/                  # 451 tests across 30 test files
...
- archetype 別 presenter 本実装（todo, form 等）
