...
前セッションで Issue #1〜#25 が完了しており、feature 層の検索・ソート・relation 観測・tags・tag filter が成立しています。
...
テスト: 441 tests 全通過、typecheck clean、lint clean
...
tests/                  # 441 tests across 29 test files
