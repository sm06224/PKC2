...
**Last updated**: 2026-04-17（§20 boot policy revision + H-10 merge-conflict-ui v1 完了追記）
...
- **C-2 entry-ordering-model** — sidebar の user-defined 並び替え
- **C-3 link-index-entry** — backlinks / forward refs の集約ビュー
